...
import ru.shur.instazoo.exceptions.ImageNotFoundException;
...
public class ImageUploadService {
    ...
    public ImageModel uploadImageToUser(MultipartFile file, Principal principal) throws IOException{
        ...
        /* Проверяем есть ли такая фотография уже у юзера, если да то удаляем */
    ...
    /* Метод который возвращает один единственный пост для юзера */
